...
public boolean HapusData(String id){
    ...
    private void initComponents() {
        ...
        comboPenulis.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Pilih", "Andriawan Niswar", "Lionel Messi", "Ustad Wawan", "Rina", "Siraji" }));
...
//            System.err.println("error (search) : " +ex);
    ...
    private void jTable2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable2MouseClicked
        ...
        comboPenulis.setSelectedItem(jTable2.getValueAt(baris, 2));
        harga2.setText(jTable2.getValueAt(baris, 3).toString());
